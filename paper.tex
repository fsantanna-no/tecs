...
the stack level 0 (ln. 13, in the middle of Figure~\ref{lst.impl.trails}).
...
%
The file \code{ceu.h} (ln. 3) contains all definitions for the compiled \CEU 
program, which are further queried through \code{\#ifdef}'s.
The file \code{ceu.c} (ln. 4) contains the main loop of \CEU pointing to the 
...
synchronous-reactive model and support for lexical composition of lines of 
execution.
%
