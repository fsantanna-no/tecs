...
We completely missed the "finalize" construct of Esterel and recognize the 
similarity with our proposal.
We now emphasize that Céu tracks pointers entering and leaving the program to 
enforce appropriate use of "finalize" (as part of the section about interfacing 
with C).
...
If the block aborts (ln. 12) during the \code{await 1s} (ln. 9), the file 
