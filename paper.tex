...
% TODO
Nested \code{emit} invocations (e.g., suppose we \code{emit c} after the 
\code{await a} in line 8) results in fine-grained micro reactions stacked one 
on top of the other, all inside the same reaction to an external event.
