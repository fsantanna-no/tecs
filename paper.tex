...
%
\CEU takes a different approach, posing a tradeoff that an \code{await} is only valid 
...
\CEU goes one step further and enforces the use of \code{finalize} for 
...
for inaccuracies in the system clock.
