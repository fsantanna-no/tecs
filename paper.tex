...
\emph{``set or reset of a signal must always precede any test of this signal
(signal coherence law and constructivity''}~\cite{esterel.saxort}.
%
...
techniques also generates \emph{``code less than $10\%$ larger the original
