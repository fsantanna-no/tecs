...
% TODO: Such analsysis is orthogonal
...
%
Note also that the application in \CEU could define an external input 
\code{TICK} and change the expiring event from \code{200ms} to \code{TICK} (ln.  
10) to recover the abstract notion of simultaneity.
