...
The execution of a program in \CEU is as follows~\cite{ceu.sensys13}:
%
\begin{enumerate}
...
We presented the design and implementation of \CEU, a synchronous reactive 
language inspired by Esterel targeting constrained embedded systems.
