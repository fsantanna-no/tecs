...
and stateful output events calls in order to preserve safe abortion of trails.
%
...
finalization clause (after the \code{with}, ln. 18) executes automatically on 
external abortion.%
\footnote{
...
components).
The right of the figure shows the associated bindings for output events (ln.  
...
%
The \emph{Sun SPOT} Java-based platform with the \emph{Squawk JVM} brings Java 
for the embedded domain~\cite{wsn.sunspot}, but requires a much powerful 
hardware.%
