...
%
Note also that the static checks are optional and do not affect the semantics
of the program.
...
%(similar to \CEU).
%
\CEU goes one step further and performs concurrency checks to detect trails 
