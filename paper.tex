...
%
Furthermore, it also affects the programmer's understanding about the code, 
...
\begin{itemize}
%
\item Stack-based execution for internal events, which provides a limited form 
of coroutines.
%
\item Static temporal analysis and deterministic execution semantics that 
allows programs to safely share memory.
%
\item Finalization mechanism for safe abortion of lines of execution holding 
external resources.
%
...
hundreds of bytes can be transmitted over the air in a few 
...
tracks the interaction of \code{par/or} compositions with pointers to local 
variables and stateful output events calls in order to preserve safe abortion 
of trails.
%
