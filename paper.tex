...
Unlike Esterel's semantics, this prevents programs to be compiled directly and
...
synchronization.}
Given the demand of timers in embedded systems, a dedicated syntax can simplify
...
and is a prerequisite for the concurrency checks that enable safe shared-memory
concurrency.
