...
\CEU is another Esterel-based language targeting embedded systems with novel 
functionalities:
%
\begin{itemize}
%
...
In this work, we discuss the design of \CEU and propose a formal semantics of a 
small synchronous kernel that represents a subset of the language covering 
...
and \emph{MICAz} sensor nodes, which use the \emph{ATmega328} 8-bit 
microcontroller with 32 Kbytes of FLASH and 2 Kbytes of SRAM.%
\footnote{
...
\\
ATmega328: \url{http://www.atmel.com/devices/atmega328.aspx}}
