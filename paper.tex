...
reacts to different input events (ln. 4,7), which cannot occur simultaneously 
(according to Section~\ref{sec.ceu.ints}).
%
...
To illustrate the risks related to abortion, consider the unsafe example in the 
